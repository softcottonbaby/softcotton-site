...
export default function Hero() {
  return (
    <div className="relative min-h-screen overflow-hidden text-white select-none">
      ...
      {/* ✨ Foreground Content */}
      <div className="relative z-10 flex flex-col justify-center items-center text-center min-h-screen px-4 pt-32 md:pt-0">
        {/* ⬇️ Logo Image */}
        <div className="mt-[-64px] w-[360px] md:w-[440px] animate-softFadeIn">
          <img
            ...
            <div className="flex flex-wrap justify-center gap-4 animate-fade-in-up">
              {[
                ...
                <a
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-full text-white font-semibold uppercase text-sm bg-gradient-to-r ${gradient} border border-white/30 backdrop-blur-md shadow-md hover:scale-105 transition ${glow} active:scale-95`}
                >
