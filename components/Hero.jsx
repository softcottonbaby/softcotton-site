...
export default function Hero() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setShowPopup(true);
    }, 2500); // Show popup after 2.5s

    const autoClose = setTimeout(() => {
      setShowPopup(false);
    }, 2500 + 3000); // Auto close 3s after it appears
  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-white select-none">
      ...
      {/* ✨ Foreground Content */}
      <div className="relative z-10 flex flex-col justify-center items-center text-center min-h-screen px-4 pt-0">
...
<div className="mt-12 flex flex-col items-center">
  <div className="flex flex-wrap justify-center gap-4 animate-fade-in-up">
    {[
      ...
      {/* 🎁 Discord Giveaway Popup with Progress Bar */}
